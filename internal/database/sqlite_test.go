...
// Test constants for duplicate string literals and credentials.
const (
	// Common test values.
	...
	testUsageID      = "usage-1"
	testCascadeFlow  = "cascade-flow"
	testPurgeID      = "purge-old-1"
	testUpdRunID     = "upd-run-1"
	testUpdFailedID  = "upd-failed-1"
	testSLMulti      = "sl-multi-1"
	testNLMulti      = "nl-multi-1"
	testBatch456     = "batch-456"
	testFlow123      = "flow-123"
	testUpdatedURL   = "https://updated.com"
	testNewProxy     = "new.proxy:9090"
	testTimedOutErr  = "timed out"
	testBasePath     = "/tmp/base.png"
	testBaselinePath = "/tmp/baseline.png"
	testVBDelID      = "vb-del-1"
	testVBDiffBase   = "vb-diff-base"
	testVBListDiff   = "vb-listdiff"
	testVBByTask     = "vb-bytask"
	testSchedDelID   = "sched-del-1"
	testSchedRunID   = "sched-run-1"
	testSecretKey    = "secret-api-key-123"
	testCapActiveID  = "cap-active-1"
	testActiveKey    = "active-key"
	testCapDelID     = "cap-del-1"
	testTaskFmt      = "Task %d"
	...
	errListProxies     = "ListProxies: %v"
	errCreateFlow      = "CreateRecordedFlow: %v"
	errGetFlow         = "GetRecordedFlow: %v"
	errListFlows       = "ListRecordedFlows: %v"
	errDeleteFlow      = "DeleteRecordedFlow: %v"
	errInsertEvent     = "InsertTaskEvent: %v"
	errInsertStepLogs  = "InsertStepLogs: %v"
	errListStepLogs    = "ListStepLogs: %v"
	errInsertNetLogs   = "InsertNetworkLogs: %v"
	errListNetLogs     = "ListNetworkLogs: %v"
	errListDOMSnaps    = "ListDOMSnapshots: %v"
	errInsertWSLogs    = "InsertWebSocketLogs: %v"
	errListWSLogs      = "ListWebSocketLogs: %v"
	errCreateSchedule  = "CreateSchedule: %v"
	errGetSchedule     = "GetSchedule: %v"
	errCreateCaptcha   = "CreateCaptchaConfig: %v"
	...
	errNew             = "New: %v"
	errIDMismatch      = "ID: got %q, want %q"
	errStatusMismatch  = "Status: got %q, want %q"
	errExpectedAfterDel = "expected error after delete"
	errUpdatedDesc     = "Updated description"
	errServerError     = "server error"
	errCreateTaskN     = "CreateTask %d: %v"
)
